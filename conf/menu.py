...
from conf.debug import DEBUG, dbg_MENU
...
#TODO, use configspec and validate it against a Validator object
    ...
    def default(self):
        ...
        populate_section(('&Edit',
            ...
            'SUB_CRO|C&aret Operations|app', 'SUB_LNO|&Line Operations|app', '__SEP__', 'EDT_CTP', 'EDT_ACP',
            'EDT_XWD', '__SEP__', 'SRT_LIN', 'SRT_REV', 'SRT_UNQ', '__SEP__', 'EDT_SUM',
            ),
            (('SUB_CRO',
        ...
        populate_section(('&View',
            ...
            (('SUB_SPT',
                'SPT_FLT', 'SPT_DLF', '__SEP__', 'SPT_DCL', 'SPT_PRJ', 'SPT_BMK', 'SPT_LNG', 'SPT_FXP',
                'SPT_SDF', 'SPT_MAC', 'SPT_TSK', 'SPT_BPT', 'SPT_DBG', 'SPT_DCM', 'SPT_CFG', 'SPT_HLP',
                'SPT_PLT', 'SPT_PFL', 'SPT_PYS', 'SPT_VLT', 'SPT_MDN', 'SPT_CFW', 'SPT_SNP',),
            ('SUB_IND',
        ...
        populate_section(('La&yout',
            ...
            # 'LAY_SPN', 'LAY_SPS', 'LAY_CCX', 'LAY_CCS', '__SEP__', 'PEF_MNU|Panel E&ffect|app',
            # '__SEP__', 'ISZ_MNU| Men&u Icons (Size Demo)|app', '__SEP__', 'LAY_MIC', 'LAY_MIK',
            # (('PEF_MNU',
...
#HACK: handle subsection reference in value
                ...
                if min_ <= len_ <= max_:
                    # ico = knd = uih = _id = sty = None
                    lbl, sct, act, hlp, ico, knd, uih, _id, sty = itm_lst
                ...
                mni = wx.MenuItem(None, _id, lbl, hlp, typ)
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                ...
                try:
                    ...
                    # frm.Bind(wx.EVT_MENU, act, id=_id)
                    # print(act)
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        for root in self:
            ...
            self.mb.Append(__walk_menu_section(root), root)
