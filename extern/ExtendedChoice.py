...
ARROW_DOWN = PNG['SmallDnArrow'].Bitmap
...
class ExtendedChoiceStyle:
    ...
    def ResetDefaults(self):
        ...
        self._selectioncolour = '#0078D7'  # wx.BLUE
        self._textselectioncolour = wx.WHITE
        self._controlcolour = wx.Colour("Light Grey")
...
class TransientChoice(wx.Dialog):
    ...
    def __init__(self, parent, style):
        ...
        self.SetSize(pos[0], pos[1]+sz[1], -1, minheight)
...
class VListChoice(wx.VListBox):
    ...
    def OnMotionWindow(self, event):
        ...
        if event.Moving():
            item = self.VirtualHitTest(event.Position[1])
            if item >= 0:
