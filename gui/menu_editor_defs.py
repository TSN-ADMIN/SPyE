...
from const.menu import NO_ACT, NO_HLP, NO_ICO, NO_KND, NO_SCT, NO_UIH
...
MENU_ITEM = {
    ...
    ##########
    'EDT_DPL': ['Duplicate &Line', 'Ctrl+Shift+D', 'tlw.edit_duplicate_line', 'Duplicate current line', 'dup_line', NO_KND, 'Doc'],
    'EDT_TPL': ['Transpose L&ine', 'Ctrl+T', 'tlw.edit_transpose_line', 'Switch current line with previous', 'transpose', NO_KND, 'Doc'],
    ...
    'SRT_LIN': ['&Sort Lines', 'Shift+F2', 'tlw.edit_sort_lines', 'Sort selected lines', 'sort', NO_KND, 'Sel'],
    'SRT_REV': ['Sort Lines Re&verse', 'Ctrl+Shift+F2', 'tlw.edit_sort_lines', 'Reverse sort selected lines', 'sort_rev', NO_KND, 'Sel'],
    'SRT_UNQ': ['Sort Lines Uni&q', 'Alt+F2', 'tlw.edit_sort_lines', 'Sort/Uniq selected lines', 'sort_uniq', NO_KND, 'Sel'],
    ...
    'SCH_INC': ['&Incremental Search...', 'Ctrl+I', 'tlw.set_search_mode', 'Progressively find text while typing', NO_ICO, NO_KND, 'Doc'],

    'SUB_SCH': ['&Option Flags', NO_SCT, None, NO_HLP, 'search_prefs', NO_KND, NO_UIH],
    ##########
    'SCH_CAS': [f'&Case Sensitive   [{SBL["CAS"][:-1]}]', 'Ctrl+F5', 'tlw.toggle_search_option', 'Toggle case sensitive search', 'sch_cas_16', 'CHECK', 'Sch'],
    'SCH_REG': [f'Regular E&xpression   [{SBL["REG"][:-1]}]', 'Ctrl+F6', 'tlw.toggle_search_option', 'Toggle regular expression search', 'sch_reg_16', 'CHECK', 'Sch'],
    'SCH_WRD': [f'Whole &Words Only   [{SBL["WRD"][:-1]}]', 'Ctrl+F7', 'tlw.toggle_search_option', 'Toggle whole words only search', 'sch_wrd_16', 'CHECK', 'Sch'],
    'SCH_WRP': [f'Wrap &Around   [{SBL["WRP"][:-1]}]', 'Ctrl+F8', 'tlw.toggle_search_option', 'Toggle wrap around search', 'sch_wrp_cus_16', 'CHECK', 'Sch'],
    'SCH_ISL': [f'In &Selection   [{SBL["ISL"][:-1]}]', 'Ctrl+F9', 'tlw.toggle_search_option', 'Toggle in selection search', 'sch_isl_16', 'CHECK', 'Sch'],
    'SCH_HLM': [f'Hig&hlight Matches   [{SBL["HLM"][:-1]}]', 'Ctrl+F10', 'tlw.toggle_search_option', 'Toggle highlight matches search', 'sch_hlm_16', 'CHECK', 'Sch'],
    'SCH_PCS': [f'&Preserve Case   [{SBL["PCS"][:-1]}]', 'Ctrl+F11', 'tlw.toggle_search_option', 'Toggle preserve case search', 'sch_pcs_16', 'CHECK', 'Sch'],
    'SCH_CXT': [f'Show conte&xt   [{SBL["CXT"][:-1]}]', NO_SCT, 'tlw.toggle_search_option', 'Toggle show context in search results', 'sch_cxt_16', 'CHECK', 'Sch'],
    'SCH_BUF': [f'Use &buffer   [{SBL["BUF"][:-1]}]', NO_SCT, 'tlw.toggle_search_option', 'Toggle use buffer for search results', 'sch_buf_16', 'CHECK', 'Sch'],
    ...
    'SPT_DCL': ['&Document', 'Alt+D', 'tlw.view_side_panel_tool', 'Show open documents in side panel', NO_ICO, NO_KND, 'Doc'],
    ...
    'RUN_DBM': ['&Debug Module ', NO_SCT, 'tlw.debugger_start', NO_HLP, NO_ICO, NO_KND, 'Doc'],
    ...
    ##########
    'FMT_TTL': ['&Title Case', NO_SCT, 'tlw.format_case', 'Update selection to title case', NO_ICO, NO_KND, 'Sel'],
    ...
    'FMT_UNI': ['U&nicode (UTF-8)', NO_SCT, not_implemented, NO_HLP,  'prefs', NO_KND, NO_UIH],
    ...
    'MAC_TST': ['Macro TEST Scintilla', NO_SCT, 'tlw.macro_TEST', NO_HLP, 'mac_rec_quick', NO_KND, 'Mac'],
    ...
    'LAY_SCH': ['&Search Panel', 'Alt+S', 'lambda e: tlw.toggle_panel(e, "SCH", -1)', 'Toggle search panel visibility', NO_ICO, 'CHECK', 'Doc'],
    'LAY_SCS': ['Swap &Search Panel', 'Ctrl+Alt+S', 'lambda e: tlw.swap_panel(e, "SCH", None)', 'Swap search panel to top/bottom', NO_ICO, NO_KND, 'Doc'],
    'LAY_RLR': ['R&uler', 'Alt+U', 'lambda e: tlw.toggle_panel(e, "RLR", 1)', 'Toggle ruler visibility', NO_ICO, 'CHECK', 'Doc'],
    'LAY_RLS': ['Swap R&uler', 'Ctrl+Alt+U', 'lambda e: tlw.swap_panel(e, "RLR", None)', 'Swap ruler to top/bottom', NO_ICO, NO_KND, 'Doc'],
    'LAY_SPN': ['Side &Panel', 'Alt+P', 'lambda e: tlw.toggle_panel(e, "SPN", -1)', 'Toggle side panel visibility', NO_ICO, 'CHECK', 'Doc'],
    'LAY_SPS': ['Swap Side &Panel', 'Ctrl+Alt+P', 'lambda e: tlw.swap_panel(e, "SPN", -1)', 'Swap side panel to left/right', NO_ICO, NO_KND, 'Doc'],
    'LAY_SPR': ['Reset Side &Panel', 'Ctrl+Alt+Shift+P', 'tlw.reset_side_panel', 'Reset side panel to default width', NO_ICO, NO_KND, 'Doc'],
    'LAY_CCX': ['C&ode Context', 'Alt+O', 'lambda e: tlw.toggle_panel(e, "CCX", 1)', 'Toggle code context window visibility', NO_ICO, 'CHECK', 'Doc'],
    'LAY_CCS': ['Swap C&ode Context', 'Ctrl+Alt+O', 'lambda e: tlw.swap_panel(e, "CCX", -1)', 'Swap code context window to top/bottom', NO_ICO, NO_KND, 'Doc'],
    ...
    'LAY_PRF': ['&Preferences...', 'F12', 'tlw.show_preferences', 'Application preferences', 'prefs', NO_KND, NO_UIH],
    ...
    'HLP_CON': ['&Contents...', 'F1', 'tlw.help_contents', NO_HLP, 'help_16', NO_KND, 'Hlp'],
    'HLP_CTX': ['&Context-sensitive Mode...', 'Alt+F1', 'tlw.help_context', NO_HLP, 'help_16', NO_KND, 'Hlp'],
    ...
    'HLP_ABT': ['&About...', 'Ctrl+F1[[bold]][[small]][[strike]]', 'tlw.help_about', 'About ' + APP['Base'], 'about', NO_KND, 'Hlp'],
}