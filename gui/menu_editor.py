...
from common.util import (
    get_keypress, me_, make_modal, scale_bitmap,
...
#TODO, add icon bitmap sizes
        ...
        self.bmp_ico = wx.StaticBitmap(self.pnl_rit, size=(32, 32), style=wx.SUNKEN_BORDER)
