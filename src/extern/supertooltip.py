...
# copied from "Python\Lib\site-packages\wx\lib\agw", (modified) module supertooltip.py
...
#                  20 Oct 2017, 20.12 GMT, TSN: textColour
#
#
# TODO List
#
...
class ToolTipWindowBase:
    ...
    def OnPaint(self, event):
        ...
        textColour = classParent.GetTextColour()  # TSN
...
#TSN        yPos = 0
        yPos = -14  # remove empty header space
        bmpXPos = 0
        ...
        yText = yPos
        embImgPos = yPos
#TSN        normalText = wx.SystemSettings.GetColour(wx.SYS_COLOUR_MENUTEXT)
        normalText = textColour  # TSN
        hyperLinkText = 'BLUE'  # TSN
...
#TSN
        ...
        # dc.DrawRectangle(0, 0, maxWidth-4, maxHeight-4)
        if event is None:
...
class SuperToolTip:
    ...
    def DoShowNow(self):
        ...
        self._endTimer.Start(int(self._endDelayTime*1000))
