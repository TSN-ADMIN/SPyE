...
IdleEventProcessSpecified = boolean(default=False)
...
WhereButton = boolean(default=True)
...
[MenuBar]
UseAltKeyAsToggle = boolean(default=False)
...
ListBoxSelBackColour = colour(default='#71B3E8')
...
MenuIconSize = integer(default=16)
