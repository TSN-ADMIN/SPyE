...
from const.searchpanel import SCH_OPT
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    def search_find_current(self, evt):
        ...
        if not fnd:
            ...
            print(f'{doc.cur_sel_wrd=}')
            fnd = doc.cur_sel_wrd
            if (fnd := doc.cur_sel_wrd) and _all:
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        if mode == 'RES':
            wx.CallAfter(dbf.FOCUS, glb.SCH.stc_res)
...
###############################################################################################################
    ...
    def toggle_search_option(self, evt):
        ...
        # get search option mapping
        mbr, sch, fld, cbx = glb.MBR, glb.SCH, *SCH_OPT[id_]

        # sync corresponding menu item, checkbox and icon
        mbr.Check(id_, evt.IsChecked())
        getattr(sch, cbx).SetValue(mbr.IsChecked(id_))
        sch.toggle_icon(fld)
