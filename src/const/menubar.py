...
NO_HLP = '[Missing help text]'  # statusbar help text

#TODO, NO_ACT, OBSOLETE when all items have action
# shortcut, action, icon, type, ui handler
NO_SCT = NO_ACT = NO_ICO = NO_KND = NO_UIH = None  # NO_ACT = None  # OR: 'not_implemented'
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    'MAC_EDT'       : __ID(),
    # layout
    'SUB_ISZ'       : __ID(),  # keyword sets icon size submenu in 'Layout'
    'LAY_CAP'       : __ID(),
    'LAY_MBR'       : __ID(),
    'LAY_TBR'       : __ID(),
    'LAY_IBR'       : __ID(),
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    # 'SUB_PEF'       : __ID(),  # panel effect submenu in 'Layout'
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    # context menu: margin
    'MGN_DBM'       : __ID(),  # clear bookmarks
    'MGN_DBP'       : __ID(),  #   "   breakpoints
    'MGN_DTM'       : __ID(),  #   "   task markers
    'MGN_DAM'       : __ID(),  #   "   all markers
